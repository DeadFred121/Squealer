...
class SquealsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create squeal" do
    assert_difference('Squeal.count') do
      post squeals_url, params: { squeal: { content: @squeal.content, user_id: @squeal.user_id } }
    end
  ...
  test "should update squeal" do
    patch squeal_url(@squeal), params: { squeal: { content: @squeal.content, user_id: @squeal.user_id } }
